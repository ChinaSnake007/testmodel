...
from unet_transformer_diffusion_raw import UNetTransformerDiffusion
import torch
import os
import numpy as np
...
def main():
    ...
    parser.add_argument('--csv_path', type=str, default='test_data\sequences_id100_ratio0.2_len32_count300000.csv', help='数据文件路径')
    parser.add_argument('--batch_size', type=int, default=256, help='批次大小')
    parser.add_argument('--max_length', type=int, default=32, help='序列最大长度')
    parser.add_argument('--num_ids', type=int, default=100, help='ID数量')
    ...
    parser.add_argument('--num_epochs', type=int, default=15, help='训练迭代次数')
    ...
    # 绘制总的训练曲线
    filename = f'training_curves_id{args.num_ids}_len{args.max_length}_miss{args.miss_ratio}_epochs{args.num_epochs}_batch{args.batch_size}_lr{model_config["learning_rate"]}.png'
